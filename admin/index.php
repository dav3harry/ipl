  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="box-body">
                <div class="row">
                <div class="col-sm-12">
                Selamat datang di Panel Administrator IPL Payment
                </div>
                                <!--
          ...
          <div class="row">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <h3>
                  <?php $vib = "SELECT * FROM `rumah`";
                   
          $connStatub = $conn->query($vib);
           
          $numberOfRowb = mysqli_num_rows($connStatub);
          ...
          //this echo out the total number of rows returned from the query
           ?>
             ...
             <a href="rumah.php" class="small-box-footer">Check <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <div class="col-lg-6 col-xs-6">
            <!-- small box -->
            <div class="small-box bg-blue">
              <div class="inner">
                <h3>
                  <?php $vib = "SELECT * FROM `user`";
                   
          $connStatuz = $conn->query($vib);
           
          $numberOfRowz = mysqli_num_rows($connStatuz);
          ...
          //this echo out the total number of rows returned from the query
           ?>
                ...
                <p>Pemilik Terdaftar</p>
              </div>
              <div class="icon">
                <i class="ion ion-person"></i>
              </div>
             <a href="user.php" class="small-box-footer">Check <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          </div>
          <div class="row">
          ...
          echo $numberOfRowb-$numberOfRows; 
          //this echo out the total number of rows returned from the query
           ?>
            
          </h3>

                <p>Belum Punya User</p>
              </div>
              <div class="icon">
    	...
    	<div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php 
              $vizt = "SELECT * FROM tagihan HAVING status='0' AND bulan<'$bulanSekarang' AND tahun<='$tahunSekarang'";
 
					$connStatues = $conn->query($vizt);
					 
					$numberOfRow = mysqli_num_rows($connStatues);
            ...
            <a href="tagihan.php" class="small-box-footer">Check <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <h3><?php $vi = "SELECT * FROM tagihan HAVING status='0' AND bulan='$bulanSekarang' AND tahun='$tahunSekarang'";
 
					$connStatu = $conn->query($vi);
					 
					$numberOfRo = mysqli_num_rows($connStatu);
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><?php $vic = "SELECT status FROM tagihan HAVING status='1'";
 
					$connStatuc = $conn->query($vic);
					 
					$numberOfRoc = mysqli_num_rows($connStatuc);
      ...
      <div class="row">
            ...
            <div class="small-box bg-green">
              <div class="inner">
                <h3>
                  <?php $vib = "SELECT * FROM tagihan HAVING status='2' AND bulan='$bulanSekarang' AND tahun='$tahunSekarang'";
                  $vit = "SELECT * FROM tagihan HAVING bulan='$bulanSekarang' AND tahun='$tahunSekarang'";
                   
          $connStatub = $conn->query($vib);
          $connStatut = $conn->query($vit);
            $numberOfRowt = mysqli_num_rows($connStatut);
          $numberOfRowb = mysqli_num_rows($connStatub);
          if($numberOfRowb/$numberOfRowt){
          	 $percentage = ($numberOfRowb/$numberOfRowt)*100;
          }else{
          	$percentage = 0;
          }
          ...
          echo round($percentage, 2, PHP_ROUND_HALF_DOWN); 
          //this echo out the total number of rows returned from the query
           ?>
