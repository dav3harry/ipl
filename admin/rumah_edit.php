...
$idOperator = $_GET['id'];
$resOperator = mysqli_query($conn, "SELECT * FROM rumah WHERE id=$idOperator");
$rowOperator = mysqli_fetch_assoc($resOperator);

if($_SERVER['REQUEST_METHOD'] == "POST"){
  $kode = mysqli_real_escape_string($conn, $_POST['kode']);
  $alamat = mysqli_real_escape_string($conn, $_POST['alamat']);
  mysqli_query($conn, "UPDATE rumah SET kode='$kode', alamat='$alamat' WHERE id='$idOperator'");
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Kode" required="required" name="kode" value="<?php echo $rowOperator['kode']; ?>">
      </div>
      <div class="form-group has-feedback">
        <textarea rows="5" class="form-control" placeholder="Alamat" required="required" name="alamat"><?php echo $rowOperator['alamat']; ?></textarea>
      </div>
      <div class="row">
        <div class="col-xs-8">
