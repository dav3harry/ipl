...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  $resLogin = mysqli_query($conn, "SELECT * FROM admin WHERE username='$username' AND password='$password'");
...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><img style="height:100px;width:auto;" src="../images/sentul.png"></img><br/><b>Management</b> Panel</a>
  </div>
  <!-- /.login-logo -->
