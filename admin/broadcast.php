...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  while ($rowUser = mysqli_fetch_assoc($resUser)) {
    $iduser = $rowUser['id'];
    mysqli_query($conn, "INSERT INTO pesan (user_id, pesan, status) VALUES ('$iduser', '$pesan', '0')");
  }
  header("Location: broadcast.php?status=sukses");
}
/*
    ...
    <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Kirim Pesan Siaran</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <?php if(isset($_GET['status'])){?>
              <div class="alert alert-success alert-dismissible" role="alert">Pesan berhasil dikirim
...
<?php } ?>
      ...
      <div class="form-group has-feedback">
        <textarea class="form-control" placeholder="Isi Pesan" rows="5" name="pesan" required="required"></textarea>
      </div>
      <div class="row">
        <div class="col-xs-8">
