...
*/
$resData = mysqli_query($conn, "SELECT * FROM rumah");
/*
    ...
    <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Rumah</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                  <div class="col-sm-8">
                    <a href="rumah_tambah.php">Tambah Rumah</a>
                  </div>
                </div>
          ...
          <?php
            ...
            $jumlah = mysqli_num_rows($cek);?>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $rowData['kode']; ?></td>
                    <td><?php echo $rowData['alamat']; if($jumlah<1){?><span class="label label-danger pull-right">
                PEMILIK BELUM TERDAFTAR</span><?php }; ?></td>
                    <td><a href="rumah_edit.php?id=<?php echo $rowData['id']; ?>"><i class="fa fa-pencil"></i></a> | <a href="rumah_hapus.php?id=<?php echo $rowData['id']; ?>"><i class="fa fa-trash"></i></a></td>
                  </tr>
                <?php $no++; } ?>
                </tbody>
              </table>
