    ...
    <section class="content">
          <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                  <div class="col-sm-8">
                    <a href="input_penggunaan.php">Input Penggunaan</a>
                  </div>
                </div>
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo bulanIndo($rowData['bulan']); ?></td>
                    <td><?php echo $rowData['tahun']; ?></td>
                    <td>
                      <?php 
                    ...
                    <td>
                      <a href="tagihan_detail.php?id=<?php echo $rowData['tagihanID']; ?>"><i class="fa fa-eye"></i></a> | 
                      <?php if($rowData['status'] == 1){ ?>
                      <a href="tagihan_approve.php?id=<?php echo $rowData['tagihanID']; ?>"><i class="fa fa-thumbs-up"></i></a> | 
                      <?php } ?>
                      <a href="tagihan_hapus.php?id=<?php echo $rowData['tagihanID']; ?>"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                <?php $no++; } ?>
                </tbody>
