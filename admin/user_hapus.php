...
$idOperator = $_GET['id'];
mysqli_query($conn, "DELETE FROM user WHERE id='$idOperator'");
...
*/
$resData = mysqli_query($conn, "SELECT * FROM operator");
/*
...
<head>
  ...
  <title>PPDB SMKN 1 Pekanbaru</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>PPDB</b>Panitia</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          ...
          <a href="#"><i class="fa fa-circle text-success"></i> Panitia</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2018 <a href="http://smkn1pekanbaru.sch.id">SMKN 1 Pekanbaru</a>.</strong> All rights
    reserved.
  </footer>
</div>
<!-- ./wrapper -->
