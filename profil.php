...
$resData = mysqli_query($conn, "SELECT *, user.id AS userID, rumah.id AS rumahID FROM user INNER JOIN rumah ON user.rumah_id = rumah.id WHERE user.id='$adminId'");
    ...
    <section class="content">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Info Profil</h3>
            </div>
          ...
          <table class="table table-bordered table-striped">
            ...
            <tr>
              <th width="40%">NIK</th>
              <td width="60%"><?php echo $rowData['nik']; ?></td>
            </tr>
            <tr>
              <th width="40%">Nomor HP</th>
              <td width="60%"><?php echo $rowData['nomor_hp']; ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td width="60%"><?php echo $rowData['email']; ?></td>
            </tr>
          </table>
        </div>
            <!-- /.box-body -->
