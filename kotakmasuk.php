...
*/
$resData = mysqli_query($conn, "SELECT * FROM pesan WHERE user_id='$adminId' ORDER BY id DESC");
mysqli_query($conn, "UPDATE pesan SET status='1' WHERE user_id='$adminId'");
/*
    ...
    <section class="content">
          <div class="box">
            ...
            <div class="box-body">
                <div class="row">
                <div class="col-sm-12">
                  <?php while($rowData=mysqli_fetch_assoc($resData)){ ?>
                  <div class="alert" role="alert" style="background-color: #ccc;">
                    <?php echo $rowData['pesan']; ?>
                    <hr>
                    Waktu : <?php echo $rowData['waktu']; ?>
                  </div>
                  <?php } ?>
                </div>
                <!--
